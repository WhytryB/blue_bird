...
if response_uses.status_code == 200:
    ...
    for entry in odata_uses.get('value', []):
        try:
            ...
            #         uses_user = True
            #         break
            print(user_name, username, uses_user)
            ...
            response_user_patch = session.patch(url, headers={'Content-Type': 'application/json; charset=utf-8'}, json={"Логин": username,"Пароль": password})
